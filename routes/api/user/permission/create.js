...
router.post('/', function(req, res, next) {
    ...
    async.waterfall([
        ...
        function(rows, cb) {
            ...
            con.query(sql, [null, user_id, val.mount_name, selected], function(err, res) { cb(err, res); });
        },
        function(result, cb) {
            var sql = "SELECT permissions.id as perm_id, permissions.selected as selected, user_id, mount_id, mounts.name as mount_name, users.username as username FROM permissions"+
